...
import bgPic from '../public/bg.jpg'
      ...
      <main className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
        ...
        <div className="flex flex-wrap items-center justify-around max-w-4xl mt-6 sm:w-full">
          <Link href="https://www.linkedin.com/in/shen-cong-48b15944/">
            <a className="p-8 mt-8 border-2 border-current w-32 rounded-full hover:bg-blue-50 hover:bg-opacity-20 focus:text-blue-300 text-gray-300">
